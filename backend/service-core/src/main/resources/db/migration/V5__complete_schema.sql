-- +JUNTOS
-- Ficheiro: backend/service-core/src/main/resources/db/migration/V5__complete_schema.sql
-- Descrição: Migração completa do schema da base de dados
-- Autor: (+JUNTOS team)
-- Locale: pt_PT

-- ===========================================
-- SCHEMA COMPLETO +JUNTOS
-- ===========================================
...
SET search_path TO juntos, public;
...
-- ===========================================
-- FUNÇÃO para atualizar campo atualizado_em
-- ===========================================
...
-- ===========================================
-- TRIGGERS para campos atualizado_em
-- ===========================================
...
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA juntos TO juntos_user;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA juntos TO juntos_user;

-- ===========================================
-- COMENTÁRIOS nas tabelas
-- ===========================================
COMMENT ON SCHEMA juntos IS 'Schema principal da aplicação +JUNTOS';
COMMENT ON TABLE juntos.users IS 'Utilizadores da aplicação';
COMMENT ON TABLE juntos.pois IS 'Pontos de Interesse familiares';
COMMENT ON TABLE juntos.events IS 'Eventos nos POIs';
COMMENT ON TABLE juntos.albums IS 'Álbuns de fotografias';
COMMENT ON TABLE juntos.photos IS 'Fotos dos álbuns';
COMMENT ON TABLE juntos.reviews IS 'Avaliações dos utilizadores';
COMMENT ON TABLE juntos.favorites IS 'POIs favoritos dos utilizadores';
COMMENT ON TABLE juntos.subscriptions IS 'Subscrições para notificações';
